...
export-env {
    ...
    let virtual_env = r#'/home/ahmed-almutairi/workspace/ice-cream-dataops/.venv'#
    let bin = r#'bin'#
    ...
    let virtual_env_prompt = (if (r#'ice-cream-dataops-py3.11'# | is-empty) {
        ($virtual_env | path basename)
    } else {
        r#'ice-cream-dataops-py3.11'#
    })
